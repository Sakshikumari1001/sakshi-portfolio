...
const About = () => {
  ...
  const whatIDoCards = [
    {
      ...
      icon: Layers,
      border: 'hover:border-indigo-400/50 hover:shadow-[0_0_30px_-5px_rgba(99,102,241,0.25)]',
      iconColor: 'text-indigo-400',
      iconBg: 'bg-indigo-600/15 border-indigo-500/25'
    },
    {
      ...
      iconBg: 'bg-purple-500/10 border-indigo-500/20'
    },
    {
  ...
  return (
    <section id="about" className="py-24 bg-[#08090e] relative border-t border-indigo-500/15 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-purple-500/10 border border-indigo-500/20 text-xs font-mono font-medium text-purple-300 mb-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-5 flex justify-center w-full">
            <div className="relative w-full max-w-md">
              ...
              <div className="absolute -inset-2 rounded-[2.5rem] bg-gradient-to-tr from-purple-600/35 via-indigo-600/25 to-indigo-500/20 blur-2xl opacity-80 -z-10 animate-pulse duration-1000"></div>
              ...
              <div className="relative rounded-[2rem] overflow-hidden border border-purple-500/25 shadow-2xl bg-[#0b111e]/90 backdrop-blur-xl group p-2">
                <div className="relative rounded-[1.6rem] overflow-hidden aspect-[4/5] bg-[#08090e]">
                  <img
                    src="/profile.png"
                    alt="Sakshi Kumari"
              ...
              <div className="absolute -top-3 -right-3 sm:-right-4 px-3.5 py-1.5 rounded-2xl bg-[#0f111f]/95 border border-purple-500/40 shadow-xl backdrop-blur-md flex items-center gap-2 text-xs font-mono font-semibold text-purple-200 hover:scale-105 transition-transform">
                <span className="w-2 h-2 rounded-full bg-purple-400 animate-ping"></span>
                <span>🎓 B.Tech CSE</span>
              </div>

              {/* Floating Badge 2: Bottom-Left — Full Stack Developer */}
              <div className="absolute -bottom-3 -left-3 sm:-left-4 px-3.5 py-1.5 rounded-2xl bg-[#0f111f]/95 border border-indigo-500/40 shadow-xl backdrop-blur-md flex items-center gap-2 text-xs font-mono font-semibold text-indigo-200 hover:scale-105 transition-transform">
                <span className="w-2 h-2 rounded-full bg-indigo-500"></span>
                <span>⚡ Full Stack Developer</span>
              </div>

              {/* Floating Badge 3: Mid-Right — Problem Solver */}
              <div className="hidden sm:flex absolute bottom-12 -right-5 px-3 py-1.5 rounded-2xl bg-[#0f111f]/95 border border-amber-500/40 shadow-xl backdrop-blur-md items-center gap-2 text-xs font-mono font-semibold text-amber-200 hover:scale-105 transition-transform">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="flex flex-wrap gap-2">
                {techPills.map((tech) => (
                  <span
                    key={tech.name}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-mono font-medium bg-[#111324]/85 text-slate-200 border border-indigo-500/20 hover:border-purple-500/40 hover:text-white transition-colors"
                  >
                    <span>{tech.icon}</span>
                    <span>{tech.name}</span>
                  </span>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-3">
              <a
                href="#projects"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-xs sm:text-sm font-semibold font-mono text-white bg-gradient-to-r from-indigo-600 via-indigo-500 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white shadow-lg shadow-indigo-600/25 transition-all transform hover:-translate-y-0.5"
              >
              ...
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-xs sm:text-sm font-semibold font-mono text-slate-200 bg-[#111324] hover:bg-[#1a1d33] border border-indigo-500/30 hover:border-slate-600 shadow-md transition-all transform hover:-translate-y-0.5"
              >
        ...
        <div className="mt-24 pt-16 border-t border-indigo-500/15">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {whatIDoCards.map((card, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`p-6 sm:p-7 rounded-3xl bg-[#0f111f]/90 border border-indigo-500/20 ${card.border} transition-all duration-300 shadow-xl hover:-translate-y-1 backdrop-blur-md flex flex-col justify-between group`}
                >
                  ...
                  <div className="pt-5 mt-5 border-t border-indigo-500/20 flex items-center gap-2 text-xs font-mono text-slate-400 group-hover:text-slate-200 transition-colors">
