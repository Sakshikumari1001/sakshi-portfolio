...
Status: Building & Learning`;
  ...
  return (
    <div className="relative w-full max-w-lg rounded-2xl overflow-hidden border border-white/10 bg-slate-900/90 shadow-2xl shadow-cyan-950/20 backdrop-blur-xl group">
      {/* Terminal Header */}
      ...
      <div className="absolute -bottom-12 -right-12 w-48 h-48 bg-cyan-500/10 rounded-full blur-3xl pointer-events-none"></div>
    </div>
  );
};
