...
const Terminal = () => {
  ...
  return (
    <div className="relative w-full max-w-lg rounded-2xl overflow-hidden border border-white/10 bg-[#111324]/90 shadow-2xl shadow-indigo-950/30 backdrop-blur-xl group">
      {/* Terminal Header */}
      <div className="flex items-center justify-between px-4 py-3 bg-[#08090e]/80 border-b border-white/5">
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 rounded-full bg-indigo-600/100 inline-block"></span>
      ...
      <div className="p-5 font-mono text-xs sm:text-sm space-y-3 leading-relaxed">
        ...
        {/* Output Block */}
        <div className="bg-[#08090e]/60 p-4 rounded-xl border border-white/5 space-y-2 font-mono text-xs">
      ...
      <div className="absolute -bottom-12 -right-12 w-48 h-48 bg-indigo-600/15 rounded-full blur-3xl pointer-events-none"></div>
    </div>
  );
};
