...
const Certifications = () => {
  ...
  return (
    <section id="certifications" className="py-24 bg-[#08090e] relative border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
          {certificationsData.map((cert, idx) => (
            <div
              key={idx}
              className="rounded-3xl bg-[#111324]/85 border border-indigo-500/20 hover:border-indigo-400/50 hover:shadow-[0_0_30px_-5px_rgba(99,102,241,0.25)] transition-all duration-300 shadow-xl flex flex-col justify-between group hover:-translate-y-1 overflow-hidden"
            >
              <div>
                {/* Certificate Visual Image Preview if available */}
                {cert.image ? (
                  <div 
                    className="relative aspect-[16/10] bg-[#08090e]/90 overflow-hidden cursor-pointer group/img border-b border-indigo-500/20 flex items-center justify-center"
                  ...
                  >
                    ...
                    />
                    {cert.badge && (
                      <span className="absolute top-2.5 right-2.5 px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold bg-[#111324]/90 text-indigo-300 border border-indigo-500/30 backdrop-blur-sm shadow-md">
                        {cert.badge}
                      </span>
                    )}
                    <div className="absolute inset-0 bg-[#08090e]/50 opacity-0 group-hover/img:opacity-100 transition-opacity flex items-center justify-center gap-2 backdrop-blur-[2px]">
                      <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-indigo-500 text-slate-950 text-xs font-mono font-bold shadow-lg">
                  ...
                  <div className="p-6 bg-gradient-to-r from-amber-500/10 via-purple-500/10 to-transparent border-b border-indigo-500/20 flex items-center justify-between">
                ...
                <div className="p-6 space-y-3">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-[10px] font-mono uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-[#16192e] text-indigo-300 border border-slate-700">
                      {cert.type}
                    </span>
                  ...
                  <div className="space-y-1 font-mono text-xs text-slate-400">
                    ...
                    {cert.certId && (
                      <div className="text-[11px] text-indigo-400/90 truncate">
                  ...
                  <div className="pt-2 border-t border-indigo-500/20 font-mono text-xs">
              ...
              <div className="px-6 py-4 border-t border-indigo-500/20 bg-[#08090e]/40 flex items-center justify-between text-xs font-mono">
      ...
      {activeModalImg && (
        ...
        >
          <div 
            className="relative max-w-4xl w-full bg-[#111324] border border-slate-700 rounded-3xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200"
              ...
              <div className="flex items-center gap-2">
                {activeModalImg.pdf && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-3 py-1.5 rounded-xl text-xs font-mono font-semibold bg-indigo-600/20 text-indigo-300 border border-indigo-500/30 hover:bg-indigo-500/30 transition-colors inline-flex items-center gap-1.5"
                  >
