...
const Certifications = () => {
  ...
  return (
    <section id="certifications" className="py-24 bg-slate-950 relative border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
          {certificationsData.map((cert, idx) => (
            <div
              key={idx}
              className="rounded-3xl bg-slate-900/80 border border-slate-800 hover:border-cyan-500/40 transition-all duration-300 shadow-xl flex flex-col justify-between group hover:-translate-y-1 overflow-hidden"
            >
              <div>
                ...
                {cert.image ? (
                  ...
                  <div className="p-6 bg-gradient-to-r from-amber-500/10 via-purple-500/10 to-transparent border-b border-slate-800 flex items-center justify-between">
                ...
                <div className="p-6 space-y-3">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-[10px] font-mono uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-slate-800 text-cyan-300 border border-slate-700">
                      {cert.type}
                    </span>
                  ...
                  <div className="space-y-1 font-mono text-xs text-slate-400">
                    ...
                    {cert.certId && (
                      <div className="text-[11px] text-cyan-400/90 truncate">
              ...
              <div className="px-6 py-4 border-t border-slate-800/80 bg-slate-950/40 flex items-center justify-between text-xs font-mono">
              ...
              <div className="flex items-center gap-2">
                {activeModalImg.pdf && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-3 py-1.5 rounded-xl text-xs font-mono font-semibold bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 hover:bg-cyan-500/30 transition-colors inline-flex items-center gap-1.5"
                  >
