...
const FeaturedProject = () => {
  ...
  return (
    <div className="relative rounded-3xl bg-[#0b101b]/95 border border-slate-800/80 p-6 sm:p-10 shadow-2xl overflow-hidden backdrop-blur-xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-8 border-b border-slate-800/60">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gradient-to-r from-indigo-500/20 via-cyan-500/20 to-teal-500/20 border border-cyan-500/30 text-xs font-mono font-semibold text-cyan-300 shadow-sm">
          <Sparkles className="w-3.5 h-3.5 text-cyan-400" />
          <span>{featuredProjectData.badgeTop}</span>
        </div>

        <div className="text-xs font-mono text-slate-400 px-3 py-1 rounded-lg bg-slate-900/60 border border-slate-800">
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            {featuredProjectData.techStack.map((tech) => (
              <span
                key={tech}
                className="px-3 py-1.5 rounded-xl text-xs font-mono font-medium bg-slate-900/90 text-slate-200 border border-slate-700/80 shadow-sm hover:border-cyan-500/40 transition-colors"
              >
                {tech}
              </span>
            ))}
          ...
          <div className="flex flex-wrap items-center gap-3.5 pt-4">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-indigo-600 to-cyan-600 hover:from-indigo-500 hover:to-cyan-500 shadow-lg shadow-indigo-500/25 font-mono transition-all transform hover:-translate-y-0.5"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-xs sm:text-sm font-semibold text-slate-200 bg-slate-900 hover:bg-slate-800 border border-slate-700/80 hover:border-slate-600 shadow-md font-mono transition-all transform hover:-translate-y-0.5"
            >
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="p-3 sm:p-4 rounded-2xl bg-slate-950/80 border border-slate-800/80 flex flex-wrap items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between p-3 rounded-xl text-xs font-mono transition-all duration-200 border text-left ${
                        isSelected
                          ...
                          : 'bg-slate-950/70 border-slate-800/80 text-slate-400 hover:bg-slate-900/90 hover:text-slate-200 hover:border-slate-700'
                      }`}
                    >
                      <div className="flex items-center gap-3">
