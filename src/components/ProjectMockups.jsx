...
export const RentRideMockup = () => {
  return (
    <div className="w-full rounded-2xl bg-[#08090e]/90 border border-white/10 p-4 font-sans text-xs text-slate-300 shadow-2xl overflow-hidden">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-white/5 font-mono text-[11px]">
        <div className="flex items-center gap-1.5">
          <span className="w-2.5 h-2.5 rounded-full bg-indigo-600/100"></span>
      ...
      {/* Search & Filter Bar */}
      <div className="mt-3 p-2.5 rounded-xl bg-[#111324]/90 border border-white/5 grid grid-cols-1 sm:grid-cols-3 gap-2 text-[11px] font-mono">
      ...
      <div className="mt-3 grid grid-cols-1 md:grid-cols-12 gap-3">
        ...
        <div className="sm:col-span-7 p-3 rounded-xl bg-[#111324]/70 border border-indigo-500/25 space-y-2">
          <div className="flex items-start justify-between">
            <div>
              <span className="text-[10px] font-mono text-indigo-400 font-medium">Premium SUV</span>
          ...
          <div className="h-24 rounded-lg bg-gradient-to-br from-slate-950 to-slate-900 border border-white/5 flex flex-col items-center justify-center p-2 text-center relative overflow-hidden">
            <Car className="w-10 h-10 text-indigo-400/70" />
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <button className="px-3 py-1 rounded-lg bg-indigo-500 text-slate-950 font-mono font-bold text-[11px]">
              Book Now
            </button>
          </div>
        </div>
        ...
        <div className="sm:col-span-5 space-y-2 text-[11px] font-mono">
          <div className="p-2.5 rounded-xl bg-[#111324]/70 border border-white/5 space-y-1.5">
            ...
            <div className="flex justify-between text-slate-300 pt-1 border-t border-white/5">
              <span>Total:</span>
              <span className="text-indigo-400 font-bold">₹9,447</span>
            </div>
          </div>

          <div className="p-2.5 rounded-xl bg-[#111324]/70 border border-white/5 flex items-center gap-2">
...
export const ProctorEdMockup = () => {
  return (
    <div className="w-full rounded-2xl bg-[#08090e]/90 border border-white/10 p-4 font-sans text-xs text-slate-300 shadow-2xl overflow-hidden">
      ...
      {/* Exam Status Bar */}
      <div className="mt-3 p-2.5 rounded-xl bg-[#111324]/90 border border-white/5 flex items-center justify-between text-[11px] font-mono">
        <div>
      ...
      <div className="mt-3 grid grid-cols-1 md:grid-cols-12 gap-3">
        ...
        {/* Left: Question Sheet */}
        <div className="sm:col-span-7 p-3 rounded-xl bg-[#111324]/70 border border-white/5 space-y-2">
          <div className="flex items-center justify-between text-[10px] font-mono text-slate-400">
            <span>Question 14 of 40</span>
            <span className="text-indigo-400">Marks: +4 / -1</span>
          </div>
          ...
          <div className="space-y-1.5 pt-1 text-[11px] font-mono">
            <div className="p-2 rounded bg-[#08090e]/70 border border-indigo-500/30 text-indigo-300 flex items-center justify-between">
              <span>B+ Tree Index</span>
              <span className="text-[10px] text-indigo-400 font-bold">Selected ✓</span>
            </div>
            <div className="p-2 rounded bg-[#08090e]/40 border border-white/5 text-slate-400">
        ...
        <div className="sm:col-span-5 space-y-2 text-[11px] font-mono">
          ...
          <div className="h-28 rounded-xl bg-[#08090e] border border-emerald-500/30 relative flex items-center justify-center overflow-hidden">
          ...
          <div className="p-2.5 rounded-xl bg-[#111324]/70 border border-white/5 space-y-1 text-[10px]">
            <div className="flex justify-between text-slate-300">
...
export const RagAssistantMockup = () => {
  return (
    <div className="w-full rounded-2xl bg-[#080d19] border border-indigo-500/20 p-4 font-sans text-xs text-slate-300 shadow-2xl overflow-hidden">
      {/* Browser Bar */}
      <div className="flex items-center justify-between pb-3 border-b border-indigo-500/20 font-mono text-[11px]">
        <div className="flex items-center gap-1.5">
          <span className="w-2.5 h-2.5 rounded-full bg-indigo-600/100"></span>
          <span className="w-2.5 h-2.5 rounded-full bg-amber-500/80"></span>
          <span className="w-2.5 h-2.5 rounded-full bg-emerald-500/80"></span>
        ...
        <span className="px-2 py-0.5 rounded bg-indigo-600/15 text-indigo-300 border border-indigo-500/25 text-[10px] font-mono">
          Groq LPU Active • 14ms
        </span>
      </div>

      {/* Repository Context Bar */}
      <div className="mt-3 p-2.5 rounded-xl bg-[#111324]/90 border border-indigo-500/20 flex flex-wrap items-center justify-between gap-2 text-[11px] font-mono">
        <div className="flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
          <span className="text-white font-semibold">Indexed Repo:</span>
          <span className="text-indigo-400">github.com/facebook/react</span>
        </div>
      ...
      <div className="mt-3 space-y-2.5 font-sans">
        ...
        <div className="p-2 rounded-lg bg-[#111324]/85 border border-indigo-500/20 flex items-center justify-between text-[10px] font-mono">
        ...
        {/* LLM Response */}
        <div className="p-3 rounded-xl bg-[#111324]/90 border border-indigo-500/20 space-y-2">
          <span className="text-[10px] font-mono text-emerald-400 font-bold flex items-center gap-1">
            <span>GROQ LLM SYNTHESIS</span>
            <span className="text-slate-500">• 480 tokens/sec</span>
          </span>
          <p className="text-xs text-slate-300 leading-relaxed">
            React's reconciler utilizes bitmask <strong>Lanes</strong> (e.g. <code className="text-indigo-300 bg-[#08090e] px-1 py-0.5 rounded">SyncLane</code>, <code className="text-indigo-300 bg-[#08090e] px-1 py-0.5 rounded">InputContinuousLane</code>, and <code className="text-indigo-300 bg-[#08090e] px-1 py-0.5 rounded">TransitionLanes</code>) in the work loop:
          </p>
          <div className="p-2 rounded-lg bg-[#08090e] border border-indigo-500/20 font-mono text-[10px] text-indigo-300">
